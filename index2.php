...
$fullData = $unifidata->list_users();

$arrayConvert = json_encode($fullData, JSON_PRETTY_PRINT);

print_r ($output_format, $data );

$result = shell_exec("python  .$arrayConvert");
#$FileName = "resultados.json";

#$OpenFile = fopen(FileName, "w");

#fwrite($OpenFile, $arrayConvert);
